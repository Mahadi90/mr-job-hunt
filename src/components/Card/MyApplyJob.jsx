...
const MyApplyJob = ({myjobs}) => {
 ...
 const {companyLogo, jobTitle, companyName, location, remoteorOnsite, fullTimeOrPartTime, salary,id} = myjobs;

    return (
        <div className='flex w-3/4 mx-auto gap-6 border p-6 items-center'>
          ...
          <div className='ms-auto'> <button className='common-btn'>View details</button></div>
        </div>
    );
};
